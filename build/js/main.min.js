...
},{"./modules/form-validate/form":3,"./modules/init-tabs":9,"./modules/modals/init-modals":10,"./modules/slider.js":12,"./modules/video-play":14,"./utils/ios-vh-fix":17}],2:[function(require,module,exports){
"use strict";
...
},{"./tabs.js":13}],10:[function(require,module,exports){
"use strict";
...
var videoWrapper = document.querySelector('[data-id="video-wrapper"]');
var videoButton = videoWrapper.querySelector('[data-id="video-button"]');
var play = function play() {
  return videoWrapper.innerHTML = '<iframe width="364" height="228" src="https://www.youtube.com/embed/9TZXsZItgdw?autoplay=1" title="YouTube video player." allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
};
var playVideo = function playVideo() {
  return videoButton.addEventListener('click', play);
};
